...
;; Increase GC threshold even more during startup
(setq gc-cons-threshold most-positive-fixnum
      gc-cons-percentage 0.6)

;; Reset after startup with more strategic timing
...
(use-package gruvbox-theme
  ...
  :init
  ;; Load the Gruvbox theme without confirmation
  (load-theme 'gruvbox-dark-soft t))  ;; You can change to 'gruvbox-light' or other variants
