...
(set-fontset-font t 'greek (font-spec :family "Geist Mono NerdFont"))
(set-fontset-font t 'latin (font-spec :family "Geist Mono NerdFont"))
(set-fontset-font t 'ascii (font-spec :family "Geist Mono NerdFont"))
(set-fontset-font t 'unicode (font-spec :family "Geist Mono NerdFont"))
#+end_src
...
(use-package dashboard
  ...
  ;; Banner and layout
  (setq dashboard-startup-banner (cons "~/.config/emacs/images/chise.png" "~/.config/emacs/ascii/eepy.txt")) ; You can use a custom path too
